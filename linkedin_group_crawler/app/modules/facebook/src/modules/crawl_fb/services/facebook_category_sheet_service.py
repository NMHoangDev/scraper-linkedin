...
class FacebookCategorySheetService:
    DEFAULT_SCOPES = [
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.info("FacebookCategorySheetService initialized successfully.")
        except Exception as e:
            logger.error(f"Error initializing FacebookCategorySheetService: {e}", exc_info=True)
            raise
    ...
    def add_record(self, tab_name: str, value: str, name: str, platform: str = "Facebook") -> bool:
        try:
            worksheet = self._get_worksheet(tab_name)
    ...
    def update_record(self, tab_name: str, value: str, name: str, platform: str = "Facebook") -> bool:
        try:
            worksheet = self._get_worksheet(tab_name)
            headers = worksheet.row_values(1)
            key_col = self._get_key_column(tab_name)
