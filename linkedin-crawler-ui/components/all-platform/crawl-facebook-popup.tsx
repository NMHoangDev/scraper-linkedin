        ...
        <>
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-[#F5F5F5] rounded-xl p-3 text-center">
              <p className="text-2xl font-black text-[#E3000F]">
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#E5E5E5] bg-[#F5F5F5]/60 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 id="crawl-fb-title" className="text-sm font-black text-[#1A1A1A]">
          ...
          <div className="flex items-center justify-center gap-3 py-3 px-6 border-b border-[#E5E5E5] shrink-0">
            ...
            <div
              className={cn(
                ...
                step > 1 ? "bg-emerald-400" : "bg-[#E5E5E5]"
              )}
            />
            ...
            <div
              className={cn(
                "flex-1 h-0.5 rounded-full max-w-[48px] transition-all",
                step > 2 ? "bg-emerald-400" : "bg-[#E5E5E5]"
              )}
            />
                          ...
                          <div className="flex items-center gap-3">
                            <div
                              className={cn(
                                ...
                                selectedAccount?.id === acc.id ? "bg-[#E3000F]" : "bg-[#A0A0A0]"
                              )}
                            >
                            ...
                            <div className="min-w-0">
                              ...
                              {acc.account_email && (
                                <p className="text-[10px] text-[#A0A0A0] truncate font-mono">
                                  {acc.account_email}
                                </p>
                              )}
          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              <div className="relative">
                <MaterialIcon
                  name="search"
                  className="absolute left-3 top-1/2 -translate-y-1/2 text-[#A0A0A0] text-base"
                />
                <input
                  type="text"
            ...
            <div className="space-y-4">
              {crawling ? (
                <div className="flex flex-col items-center justify-center py-12">
                  <div className="w-12 h-12 border-4 border-[#E5E5E5] border-t-[#E3000F] rounded-full animate-spin mb-4" />
                  <h3 className="text-sm font-bold text-[#1A1A1A]">Đang xử lý cào dữ liệu...</h3>
                  <p className="text-[11px] text-[#A0A0A0] mt-2 text-center max-w-[80%]">
                ...
                <div className="text-center py-6">
                  ...
                  <h3 className="text-sm font-bold text-[#1A1A1A]">Cào dữ liệu thất bại</h3>
          ...
          {step === 1 && (
            <>
              ...
              <button
                type="button"
                onClick={() => setStep(2)}
                className="flex-1 font-bold py-2.5 rounded-xl text-xs transition shadow-sm flex items-center justify-center gap-1.5 cursor-pointer bg-[#E3000F] hover:bg-[#166FE5] text-white"
              >
                Tiếp theo
              ...
              <button
                ...
                className={cn(
                  ...
                  crawling || selectedGroups.size === 0
                    ...
                    : "bg-[#E3000F] hover:bg-[#166FE5] text-white cursor-pointer"
                )}
              >
                {crawling ? (
                  <>
