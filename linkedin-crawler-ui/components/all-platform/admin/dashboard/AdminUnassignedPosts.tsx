    ...
    <div className="bg-white border border-slate-100 rounded-2xl p-5 flex flex-col w-full">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-sm font-bold text-slate-800 flex items-center gap-2">
          <MaterialIcon name="assignment" className="text-[#DC2626] text-[18px]" />
        ...
        {unassignedPosts.map((post) => (
          <div key={post.id} className="py-3 first:pt-0 last:pb-0 flex items-center justify-between gap-4">
            <div className="flex flex-col min-w-0 flex-1">
              <a href="#" className="font-bold text-sm text-slate-800 hover:text-blue-600 truncate mb-1 transition-colors">
                {post.title}
              </a>
            ...
            <div className="flex flex-col items-end gap-1.5 shrink-0">
              ...
              <button className="bg-[#DC2626] hover:bg-[#B91C1C] text-white text-[11px] font-bold px-3 py-1.5 rounded-lg transition-colors shadow-sm active:scale-95 flex items-center gap-1">
