...
/** Trang chủ của zalo-module — module này chỉ có 2 trang (Tài khoản Zalo +
 * Inbox Zalo), không có Admin/Leader Dashboard riêng — mọi role đều về
 * thẳng trang Inbox sau khi đăng nhập. */
export function getDashboardHrefForRole(_role?: string | null): string {
  return "/all-platform/zalo-inbox";
}

export function buildEntries(_isAdmin: boolean, _isLeader: boolean, _workspaceTab: "personal" | "team", _isSale: boolean = false): SidebarEntry[] {
  return [
    {
      type: "item",
      id: "zalo-inbox",
