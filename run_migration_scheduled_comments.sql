-- Run this SQL in the Supabase SQL editor (https://seeding.db.markeeai.com or production DB)
-- to create the scheduled_comments table for the scheduled posting feature.
