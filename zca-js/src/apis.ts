...
export class API {
    ...
    public getCMOld: ReturnType<typeof getCMOldFactory>;
    public getCMRecent: ReturnType<typeof getCMRecentFactory>;
    ...
    public getUserChatHistory: ReturnType<typeof getUserChatHistoryFactory>;
